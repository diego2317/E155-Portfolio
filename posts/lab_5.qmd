...
## Introduction
The goal of this lab was to develop experience with interrupts by using them on our MCU to determine the speed of a motor by reading from a quadrature encoder. As always, the code for this lab can be found in the lab 5 folder of my [Github repository for E155](https://github.com/diego2317/E155-labs).
...
I found that my main loop runs at approximately 17.5 KHz via oscilloscope analysis.
